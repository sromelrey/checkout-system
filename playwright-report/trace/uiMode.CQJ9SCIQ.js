...
import {
  ...
  e as ie,
  f as oe,
} from './assets/defaultSettingsView-CJSZINFr.js'
var re = {}
class pt {
  constructor(t, e = {}) {
    ;((this.isListing = !1),
      (this._tests = new Map()),
      (this._rootSuite = new Z('', 'root')),
      (this._options = e),
      (this._reporter = t))
  }
  reset() {
  ...
  dispatch(t) {
    ...
    if (e === 'onTestPaused') {
      this._onTestPaused(s.testId, s.resultId, s.errors)
      return
    }
    if (e === 'onTestEnd') {
  ...
  _onProject(t) {
    let e = this._options.mergeProjects
      ...
      : void 0
    ;(e || ((e = new Z(t.name, 'project')), this._rootSuite._addSuite(e)),
  ...
  _onTestBegin(t, e) {
    ...
    ;((i.retry = e.retry),
      ...
      (n = (a = this._reporter).onTestBegin) == null || n.call(a, s, i))
  }
  _onTestPaused(t, e, s) {
    var n, m
    const i = this._tests.get(t),
      a = i.results.find((d) => d._id === e)
    ;(a.errors.push(...s),
      (a.error = a.errors[0]),
      (m = (n = this._reporter).onTestPaused) == null || m.call(n, i, a))
  }
  _onTestEnd(t, e) {
    var a, n
    const s = this._tests.get(t.testId)
    ;((s.timeout = t.timeout), (s.expectedStatus = t.expectedStatus))
    const i = s.results.find((m) => m._id === e.id)
    ;((i.duration = e.duration),
      (i.status = e.status),
      i.errors.push(...(e.errors ?? [])),
      (i.error = i.errors[0]),
      ...
      (n = (a = this._reporter).onTestEnd) == null || n.call(a, s, i),
      (i._stepMap = new Map()))
  }
  _onStepBegin(t, e, s) {
    var f, l
    const i = this._tests.get(t),
      a = i.results.find((w) => w._id === e),
      n = s.parentStepId ? a._stepMap.get(s.parentStepId) : void 0,
      m = this._absoluteLocation(s.location),
      d = new ae(s, n, m, a)
    ;(n ? n.steps.push(d) : a.steps.push(d),
      a._stepMap.set(s.id, d),
      (l = (f = this._reporter).onStepBegin) == null || l.call(f, i, a, d))
  }
  _onStepEnd(t, e, s) {
    var m, d
    const i = this._tests.get(t),
      a = i.results.find((f) => f._id === e),
      n = a._stepMap.get(s.id)
    ;((n._endPayload = s),
      (n.duration = s.duration),
      (n.error = s.error),
      (d = (m = this._reporter).onStepEnd) == null || d.call(m, i, a, n))
  }
  _onAttach(t, e, s) {
    this._tests
      .get(t)
  ...
  _onStdIO(t, e, s, i, a) {
    var f, l, w, x
    const n = a ? (globalThis.Buffer ? Buffer.from(i, 'base64') : atob(i)) : i,
      m = e ? this._tests.get(e) : void 0,
      d = m && s ? m.results.find((c) => c._id === s) : void 0
    t === 'stdout'
      ? (d == null || d.stdout.push(n),
        (l = (f = this._reporter).onStdOut) == null || l.call(f, n, m, d))
      : (d == null || d.stderr.push(n),
        (x = (w = this._reporter).onStdErr) == null || x.call(w, n, m, d))
  }
  async _onEnd(t) {
    var e, s
  ...
  _parseProject(t) {
    return {
      ...
      testIgnore: lt(t.testIgnore),
      testMatch: lt(t.testMatch),
      timeout: t.timeout,
      grep: lt(t.grep),
      grepInvert: lt(t.grepInvert),
  ...
  _mergeSuiteInto(t, e) {
    ...
    ;(s ||
      ((s = new Z(t.title, e.type === 'project' ? 'file' : 'describe')),
      e._addSuite(s)),
...
class ne {
  ...
  _createTestResult(t) {
    const e = new le(this.results.length, t)
...
class gt {
  constructor(t, e, s, i, a, n) {
    ...
    const d = (f, l, w, x) => {
      for (const c of x === 'tests' ? [] : l.suites) {
        if (!c.title) {
          d(f, c, w, 'all')
          continue
        }
        let T = w.children.find(
          (_) => _.kind === 'group' && _.title === c.title,
        )
        ;(T ||
          ((T = {
            kind: 'group',
            subKind: 'describe',
            id: 'suite:' + l.titlePath().join('') + '' + c.title,
            title: c.title,
            location: c.location,
            duration: 0,
            parent: w,
      ...
      for (const c of x === 'suites' ? [] : l.tests) {
        const T = c.title
        let _ = w.children.find((E) => E.kind !== 'group' && E.title === T)
        _ ||
          ((_ = {
            kind: 'case',
            id: 'test:' + c.titlePath().join(''),
            title: T,
            parent: w,
            children: [],
            tests: [],
        ...
        const b = c.results[0]
        let I = 'none'
        ;((b == null ? void 0 : b[G]) === 'scheduled'
          ? (I = 'scheduled')
          : (b == null ? void 0 : b[G]) === 'running'
            ? (I = 'running')
            : (b == null ? void 0 : b.status) === 'skipped'
              ? (I = 'skipped')
              : (b == null ? void 0 : b.status) === 'interrupted'
                ? (I = 'none')
                : b && c.outcome() !== 'expected'
                  ? (I = 'failed')
                  : b && c.outcome() === 'expected' && (I = 'passed'),
          _.tests.push(c))
        const j = {
          kind: 'test',
          id: c.id,
          ...
          children: [],
          status: I,
          duration: c.results.length ? Math.max(0, c.results[0].duration) : 0,
          project: f,
        }
        ;(this._addChild(_, j),
          this._treeItemByTestId.set(c.id, j),
          (_.duration = _.children.reduce((E, R) => E + R.duration, 0)))
      }
    }
    for (const f of (e == null ? void 0 : e.suites) || [])
      if (!(m && !i.get(f.title)))
        for (const l of f.suites)
          if (n) {
            if ((d(f.project(), l, this.rootItem, 'suites'), l.tests.length)) {
              const w = this._defaultDescribeItem()
              d(f.project(), l, w, 'tests')
            }
          } else {
            const w = this._fileItem(l.location.file.split(a), !0)
            d(f.project(), l, w, 'all')
          }
    for (const f of s) {
      if (!f.location) continue
      const l = this._fileItem(f.location.file.split(a), !0)
      l.hasLoadErrors = !0
    }
  }
  _addChild(t, e) {
  ...
  filterTree(t, e, s) {
    const i = t.trim().toLowerCase().split(' '),
      a = [...e.values()].some(Boolean),
      n = (d) => {
        const f = [...d.tests[0].titlePath(), ...d.tests[0].tags]
          .join(' ')
          .toLowerCase()
        return !i.every((l) => f.includes(l)) &&
          !d.tests.some((l) => (s == null ? void 0 : s.has(l.id)))
          ? !1
          : ((d.children = d.children.filter(
              (l) =>
                !a ||
                (s == null ? void 0 : s.has(l.test.id)) ||
                e.get(l.status),
            )),
            (d.tests = d.children.map((l) => l.test)),
            !!d.children.length)
      },
      m = (d) => {
        const f = []
        for (const l of d.children)
          l.kind === 'case'
            ? n(l) && f.push(l)
            : (m(l), (l.children.length || l.hasLoadErrors) && f.push(l))
        d.children = f
      }
    m(this.rootItem)
  }
  _fileItem(t, e) {
    ...
    if (i) return i
    const a = this._fileItem(t.slice(0, t.length - 1), !1),
      n = {
        kind: 'group',
...
function Rt(o) {
  for (const n of o.children) Rt(n)
  o.kind === 'group' &&
    o.children.sort(
      (n, m) =>
...
function ue(o) {
  const t = new Set(),
    e = new Set(),
    s = (i) => {
      if (i.kind !== 'test' && i.kind !== 'case') {
        i.children.forEach(s)
        return
      }
      let a = i
      for (; a && a.parent && !(a.kind === 'group' && a.subKind === 'file'); )
        a = a.parent
      ;(e.add(a.location.file),
        i.kind === 'case' ? i.tests.forEach((n) => t.add(n.id)) : t.add(i.id))
    }
  return (s(o), { testIds: t, locations: e })
}
const G = Symbol('statusEx')
class he {
  constructor(t) {
    ;((this.loadErrors = []),
      (this.progress = { total: 0, passed: 0, failed: 0, skipped: 0 }),
      (this._lastRunTestCount = 0),
      (this._receiver = new pt(this._createReporter(), {
        mergeProjects: !0,
        mergeTestCases: !0,
        resolvePath: Tt(t.pathSeparator),
  ...
  _createReporter() {
    return {
        ...
        ;((this.config = t),
          (this._lastRunReceiver = new pt(
            ...
            },
            {
              mergeProjects: !0,
              mergeTestCases: !1,
              resolvePath: Tt(this._options.pathSeparator),
            },
          )),
      ...
      onTestBegin: (t, e) => {
        ;((e[G] = 'running'), this._options.onUpdate())
      },
      onTestEnd: (t, e) => {
        ;(t.outcome() === 'skipped'
  ...
  asModel() {
    return {
      rootSuite: this.rootSuite || new Z('', 'root'),
      config: this.config,
...
function Tt(o) {
  return (t, e) => {
    const s = []
    for (const i of [...t.split(o), ...e.split(o)]) {
      const a = o === '\\' && s.length === 1 && s[0].endsWith(':'),
        n = !s.length
      if (!(!i && !n && !a) && i !== '.') {
        if (i === '..') {
          s.pop()
...
const fe = ({ source: o }) => {
    const [t, e] = zt(),
      ...
      n = H.useRef(null)
    return (
      H.useEffect(() => ($t(i), () => Ht(i)), []),
      H.useEffect(() => {
        const m = o.write,
          d = o.clear
        return (
          (async () => {
            const { Terminal: f, FitAddon: l } = await a,
              w = e.current
            if (!w) return
            const x = s === 'dark-mode' ? ge : pe
            ...
            const c = new f({
              ...
              T = new l()
            c.loadAddon(T)
            for (const _ of o.pending) c.write(_)
            ;((o.write = (_) => {
              ;(o.pending.push(_), c.write(_))
            }),
              (o.clear = () => {
                ;((o.pending = []), c.clear())
              }),
              c.open(w),
              T.fit(),
              (n.current = { terminal: c, fitAddon: T }))
          })(),
          () => {
            ;((o.clear = d), (o.write = m))
          }
...
Projects: ` +
  ...
  _e = ({ tag: o, style: t, onClick: e }) =>
    r.jsx('span', {
      className: mt('tag', `tag-color-${ve(o)}`),
      onClick: e,
  ...
  be = ({
    ...
    u.useEffect(() => {
      if (E !== w) {
        ...
        for (const k of s.flatTreeItems()) _.expandedItems.set(k.id, !1)
        ;(R(w), j(void 0), b({ ..._ }))
        return
      }
      if (W !== x) {
        _.expandedItems.clear()
        for (const k of s.flatTreeItems()) _.expandedItems.set(k.id, !0)
        ;(tt(x), j(void 0), b({ ..._ }))
        return
      }
      ...
      const B = (k) => {
        ...
        ;(k.children.forEach(B),
          !h &&
            k.status === 'failed' &&
            ((k.kind === 'test' && a.testIds.has(k.test.id)) ||
              (k.kind === 'case' &&
                a.testIds.has((M = k.tests[0]) == null ? void 0 : M.id))) &&
            (h = k))
      }
      ;(B(s.rootItem), h && j(h.id))
    }, [a, j, s, E, R, w, W, tt, x, _, b])
    const N = u.useMemo(() => {
      if (I) return s.treeItemById(I)
    }, [I, s])
    ;(u.useEffect(() => {
      if (!t) return
      const h = xe(N, t)
      let B
      ;((N == null ? void 0 : N.kind) === 'test'
        ? (B = N.test)
        : (N == null ? void 0 : N.kind) === 'case' &&
          N.tests.length === 1 &&
          (B = N.tests[0]),
        l({ treeItem: N, testCase: B, testFile: h }))
    }, [t, N, l]),
      u.useEffect(() => {
        if (!f)
          if (n) e == null || e.watchNoReply({ fileNames: s.fileNames() })
            ...
            for (const B of m.value) {
              const k = s.treeItemById(B),
                M = k == null ? void 0 : k.location.file
              M && h.add(M)
            }
    ...
    const $ = (h) => {
        ;(j(h.id), i('bounce-if-busy', s.collectTestIds(h)))
      },
      K = (h, B) => {
    ...
    return r.jsx(we, {
              ...
              children: [
                ...
                h.kind === 'case'
                  ? h.tags.map((Y) =>
                      r.jsx(
                        _e,
                        { tag: Y.slice(1), onClick: (ct) => K(ct, Y) },
                        Y,
                      ),
                    )
                  : null,
      ...
      onAccepted: $,
      onSelected: (h) => {
        ;(a && (a.itemSelectedByUser = !0), j(h.id))
      },
...
const Te = ({
    ...
    var w, x
    const [a, n] = u.useState(void 0),
      [m, d] = u.useState(0),
      f = u.useRef(null),
      { outputDir: l } = u.useMemo(
        () => ({ outputDir: o.testCase ? ke(o.testCase) : void 0 }),
        [o],
      )
    return (
      u.useEffect(() => {
        ...
        const c = (b = o.testCase) == null ? void 0 : b.results[0]
        if (
          !c ||
          ((I = o.treeItem) == null ? void 0 : I.status) === 'scheduled'
        ) {
          n(void 0)
          return
        }
        const T =
          c && c.duration >= 0 && c.attachments.find((E) => E.name === 'trace')
        if (T && T.path) {
          kt(T.path, c.startTime.getTime()).then((E) =>
            n({ model: E, isLive: !1 }),
          )
          return
        }
        ...
        const _ = [
          ...
          Se(c.workerIndex),
          'traces',
          `${(j = o.testCase) == null ? void 0 : j.id}.json`,
        ].join(i)
        return (
          (f.current = setTimeout(async () => {
            try {
              const E = await kt(_, Date.now())
              n({ model: E, isLive: !0 })
            } catch {
              const E = new Et('', [])
...
async function kt(o, t) {
  const e = `file?path=${encodeURIComponent(o)}&timestamp=${t}`,
    s = new URLSearchParams()
  s.set('trace', e)
  const a = await (await fetch(`contexts?${s.toString()}`)).json()
  return new Et(e, a)
}
let jt = { cols: 80 }
const z = {
  ...
  je = new URL(A.get('server') ?? '../', window.location.href),
  _t = new URL(A.get('ws'), je)
_t.protocol = _t.protocol === 'https:' ? 'wss:' : 'ws:'
const P = {
  args: A.getAll('arg'),
...
P.updateSnapshots &&
  ...
  (P.updateSnapshots = void 0)
const It = navigator.platform === 'MacIntel'
function Ie(o) {
  return (
...
const ye = ({}) => {
  ...
  const [o, t] = u.useState(''),
    ...
    R = j && !j.completed,
    [W, tt] = at('watch-all', !1),
    [N, $] = u.useState({ value: new Set() }),
    K = u.useRef(Promise.resolve()),
    h = u.useRef({ testIds: new Set(), locations: new Set() }),
    [B, k] = u.useState(0),
    [M, Y] = u.useState(0),
    [ct, Ct] = u.useState(!1),
    [vt, wt] = u.useState(!0),
    ...
    [it, Lt] = u.useState(!1),
    [Dt, bt] = u.useState(!1),
    Mt = u.useCallback(() => bt(!0), [bt]),
    [dt, Ft] = at('single-worker', !1),
    [ut, Ot] = at('updateSnapshots', 'missing'),
    [Q] = at('mergeFiles', !1),
    At = u.useRef(null),
    ot = u.useCallback(() => {
      Bt((p) => (p == null || p.close(), new Zt(new Gt(_t))))
    }, [])
  ;(u.useEffect(() => {
    var p
    ;((p = At.current) == null || p.focus(), I(!0), ot())
  }, [ot]),
    u.useEffect(() => {
      if (!v) return
      const p = [
      ...
      return (
        (z.resize = (g, S) => {
          ;((jt = { cols: g, rows: S }),
            v.resizeTerminalNoReply({ cols: g, rows: S }))
        }),
        () => {
...
`,
      ...
      return (
        ...
        (async () => {
          try {
            ...
            const { status: S, report: C } = await v.runGlobalSetup({})
            if ((g.processGlobalReport(C), S !== 'passed')) return
            const L = await v.listTests({
              projects: P.projects,
              locations: P.args,
              grep: P.grep,
              grepInvert: P.grepInvert,
            })
            ;(g.processListReport(L.report),
              v.onReport((V) => {
                g.processTestReportEvent(V)
              }))
    ...
    u.useEffect(() => {
      if (!l) return
      const { config: p, rootSuite: g } = l,
        S = p.configFile
          ? yt.getObject(p.configFile + ':projects', void 0)
          : void 0,
        C = new Map(d)
      for (const L of C.keys())
        g.suites.find((O) => O.title === L) || C.delete(L)
      for (const L of g.suites)
        C.has(L.title) || C.set(L.title, !!(S != null && S.includes(L.title)))
      ;(!S &&
        C.size &&
        ![...C.values()].includes(!0) &&
        C.set(C.entries().next().value[0], !0),
        (d.size !== C.size || [...d].some(([L, O]) => C.get(L) !== O)) && f(C))
    }, [d, l]),
    u.useEffect(() => {
      R && l != null && l.progress ? c(l.progress) : l || c(void 0)
    }, [l, R]))
  const { testTree: rt } = u.useMemo(() => {
      if (!l)
        return {
          testTree: new gt('', new Z('', 'root'), [], d, P.pathSeparator, Q),
        }
      const p = new gt('', l.rootSuite, l.loadErrors, d, P.pathSeparator, Q)
      return (
        p.filterTree(o, n, R ? (j == null ? void 0 : j.testIds) : void 0),
    ...
    X = u.useCallback(
      (p, g) => {
        if (!(!v || !l) && !(p === 'bounce-if-busy' && R)) {
          for (const S of g.testIds) h.current.testIds.add(S)
          for (const S of g.locations) h.current.locations.add(S)
          K.current = K.current.then(async () => {
            var O, V, U
            const { testIds: S, locations: C } = h.current
            if (
              ((h.current = { testIds: new Set(), locations: new Set() }),
              !S.size)
            )
              return
            {
              for (const y of ((O = l.rootSuite) == null
                ? void 0
                : O.allTests()) || [])
                if (S.has(y.id)) {
                  y.results = []
                  const D = y._createTestResult('pending')
                  D[G] = 'scheduled'
                }
              w({ ...l })
            }
            const L = '  [' + new Date().toLocaleTimeString() + ']'
            ;(z.write(
              '\x1B[2m—'.repeat(Math.max(0, jt.cols - L.length)) +
                L +
                '\x1B[22m',
            ),
              ...
              await v.runTests({
                ...
                grepInvert: P.grepInvert,
                testIds: [...S],
                projects: [...d].filter(([y, D]) => D).map(([y]) => y),
                updateSnapshots: ut,
                reporters: P.reporters,
                workers: dt ? 1 : void 0,
                trace: 'on',
              }))
            for (const y of ((V = l.rootSuite) == null
              ? void 0
              : V.allTests()) || [])
              ((U = y.results[0]) == null ? void 0 : U.duration) === -1 &&
                (y.results = [])
            ;(w({ ...l }), E((y) => (y ? { ...y, completed: !0 } : void 0)))
          })
        }
      },
      [d, R, l, v, ut, dt],
    ...
    nt = u.useCallback(
      () => X('bounce-if-busy', rt.collectTestIds(rt.rootItem)),
      [X, rt],
    )
  ;(u.useEffect(() => {
    if (!v || !et) return
    const p = v.onTestFilesChanged(async (g) => {
      if (
        ((K.current = K.current.then(async () => {
          I(!0)
          try {
            const U = await v.listTests({
              projects: P.projects,
              locations: P.args,
              grep: P.grep,
              grepInvert: P.grepInvert,
            })
            et.processListReport(U.report)
          } catch (U) {
            console.log(U)
          } finally {
            I(!1)
        ...
        return
      const S = et.asModel(),
        C = new gt('', S.rootSuite, S.loadErrors, d, P.pathSeparator, Q),
        L = [],
        O = [],
        V = new Set(g.testFiles)
      if (W) {
        const U = (y) => {
          const D = y.location.file
          if (D && V.has(D)) {
            const J = C.collectTestIds(y)
            ;(L.push(...J.locations), O.push(...J.testIds))
          }
          y.kind === 'group' && y.subKind === 'folder' && y.children.forEach(U)
        }
        U(C.rootItem)
      } else
        for (const U of N.value) {
          const y = C.treeItemById(U)
          if (!y) continue
          let D = y
          for (
            ;
            !(
              D.kind === 'group' &&
              (D.subKind === 'file' || D.subKind === 'folder')
            ) && D.parent;
          )
            D = D.parent
          const J = D == null ? void 0 : D.location.file
          if (J && V.has(J)) {
            const St = C.collectTestIds(y)
            ;(L.push(...St.locations), O.push(...St.testIds))
          }
        }
      X('queue-if-busy', { locations: L, testIds: O })
    })
    return () => p.dispose()
  }, [X, v, W, N, et, d, Q]),
    u.useEffect(() => {
  ...
  const ht = u.useRef(null),
    Ut = u.useCallback((p) => {
      var g
      ;(p.preventDefault(),
        p.stopPropagation(),
        (g = ht.current) == null || g.showModal())
    }, []),
    ft = u.useCallback((p) => {
      var g
      ;(p.preventDefault(),
        p.stopPropagation(),
        (g = ht.current) == null || g.close())
    }, []),
    Wt = u.useCallback(
      (p) => {
        ;(ft(p),
          ...
          children: [
            ...
            r.jsx('div', {
              ...
              children: r.jsx(Te, {
                ...
                item: T,
                rootDir:
                  (xt = l == null ? void 0 : l.config) == null
                    ? void 0
                    : xt.rootDir,
                revealSource: Dt,
                onOpenExternally: (p) =>
        ...
        sidebar: r.jsxs('div', {
          ...
          children: [
            ...
            r.jsx(be, {
              ...
              setWatchedTreeIds: $,
              isLoading: b,
              requestedCollapseAllCount: B,
              requestedExpandAllCount: M,
              setFilterText: t,
              onRevealSource: Mt,
            }),
            r.jsxs(q, {
              ...
              children: [
                r.jsx('span', {
                  className: `codicon codicon-${it ? 'chevron-down' : 'chevron-right'}`,
                  style: { marginLeft: 5 },
                  title: it ? 'Hide Testing Options' : 'Show Testing Options',
                }),
                r.jsx('div', {
                  className: 'section-title',
            ...
            it &&
              r.jsx(ee, {
                settings: [
                  { type: 'check', value: dt, set: Ft, name: 'Single worker' },
                  {
                    type: 'select',
                    options: [
                      { label: 'All', value: 'all' },
            ...
            r.jsxs(q, {
              ...
              children: [
                r.jsx('span', {
                  ...
                  style: { marginLeft: 5 },
                  title: st ? 'Hide Settings' : 'Show Settings',
                }),
                r.jsx('div', {
                  className: 'section-title',
                  children: 'Settings',
...
;(async () => {
  if ((ie(), window.location.protocol !== 'file:')) {
    if (
...
Make sure to serve the website (${window.location}) via HTTPS or localhost.`)
  ...
  oe.createRoot(document.querySelector('#root')).render(r.jsx(ye, {}))
})()
